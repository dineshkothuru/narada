...
import { computeTotals, toLines, type RawItem } from "@/lib/billing-math";
...
describe("computeTotals", () => {
  ...
  it("defaults a missing GST rate to the restaurant standard of 5%", () => {
    const [line] = toLines([
      { name: "Mystery", qty: 1, unit_price: 100 } as unknown as RawItem,
    ]);
