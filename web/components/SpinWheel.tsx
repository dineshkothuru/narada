    ...
    <div className="flex flex-col items-center">
      <div className="relative">
        ...
        >
          ...
          <circle cx="130" cy="130" r="24" fill="#1c1410" />
      ...
      {!done && (
        <button
          onClick={spin}
          disabled={spinning}
          className="mt-4 rounded-full bg-gradient-to-r from-orange-600 to-amber-500 px-10 py-3 text-sm font-bold text-white shadow-lg transition active:scale-95 disabled:opacity-60"
        >
          {strings.spin}
        </button>
      )}
